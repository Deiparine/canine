    ...
    <Container className="acl-container my-5">
      <Row className="mb-3 pb-5">
        <Col md={8}>
          ...
          <p>
            ...
            Unlike humans, canine ACL tears are typically a chronic degenerative
            process rather than acute traumatic injury. Left untreated, canine
            ACL tears often lead to a high incidence opposite side tearing,
        ...
        <Col md={4}>
          <img src={BrownDog} alt="Brown Hairy Dog" style={{ width: "100%" }} />
        </Col>
      </Row>
      <Row className="my-3 py-5">
        <Col md={8}>
          ...
          <p>
            Colorado Canine Orthopedics is offering telemedicine appointments to
            discuss ACL tears, the TPLO surgery, aftercare and prognosis. A
            ...
            experienced board-certified surgeons will evaluate the information,
            suggest the likely diagnosis and answer any questions you might have
            regarding canine ACL tears and optimal treatment options. Please
            call us at 719-264-6666 to schedule your appointment.
          </p>
        </Col>
        <Col md={4}>
      ...
      <Row className="my-3 py-5">
        <Col md={8}>
          ...
          <p>
            Canine ACL tears are the result of chronic biomechanical wear rather
            than acute trauma. Unlike humans, dogs have a sloping tibial plateau
            (figure 1). Because of the canine sloping tibial plateau, the femur
            slides down and back the sloping tibial plateau during weight
            bearing resulting in biomechanical stress and ultimately
            degeneration and tearing of the ACL (figures 2 and 3). In dogs, the
            ACL almost always tears or degenerates gradually over time due to
            this chronic biomechanical stress. This degenerative process is well
            documented via arthroscopy (figure 4).
          </p>
          <div className="d-flex justify-content-between">
            <img
              ...
              style={{ width: "auto" }}
            />
            <img src={slidingRad} alt="Sliding Rad" style={{ width: "auto" }} />
          </div>
        </Col>
      ...
      <Row className="my-3 py-5">
        <Col md={8}>
          ...
          <p>
            ...
            from subtle lameness to complete non-weight bearing. Subtle lameness
            and “off-weighting” the leg are often seen early in the
            degenerative, tearing process. However, many dogs have persistent,
            moderate to severe lameness. The degree of lameness is influenced by
            the progressive osteoarthritis seen with ACL pathology, degree of
            tearing and concurrent meniscal tears.
          </p>
          <p>
            Almost all dogs with ACL problems sit to the side, even when sitting
            for a treat. Sometimes the lameness comes on quickly but often it’s
            a gradual progressive problem. It is not uncommon for the problem to
            wax and wane for weeks or even months.
          </p>
          ...
          <p>
            ...
            nearly half of all dogs with ACL problems due to gradual, incomplete
            tearing and the ensuing scar tissue that develops as the ligament
            degenerates. The formation of scar tissue is also termed “joint
            fibrosis” and while this tissue does help stabilize the joint, it
            also decreases range of motion an is a source of chronic pain.
          </p>
          <p>
