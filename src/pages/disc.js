				...
				<div class="container">
					<div class="hero-content-wrapper">
						...
						<div class="inner-page-title text-center disc-hero">
							<h1>Canine Intervertebral Disc Disease</h1>
						</div>
					</div>
				</div>
			</div>
				...
				<Row className="mb-3 pb-5 border-none">
					...
					<Col md={5}>
						<div className="mb-4">
							...
							>
								Figure 1: Normal Intervertebral Disc
							</p>
						</div>
						<div className="mb-4">
							<img
				...
				<Row className="mb-3 pb-5 border-none">
					<Col md={7}>
						...
						<p>
							...
							small breed dogs (figure 3). Contrast media is often used in
				...
				<Row className="mb-3 pb-5 border-none">
					<Col md={7}>
						...
						<p>
							...
							thoracolumbar IVDD in small breed dogs (figure 4). Contrast media
							is often used in conjunction with CT imaging. Magnetic resonance
							imaging (MRI) is also used to diagnose canine spinal disorders but
							is most applicable in large breed dogs, lumbosacral IVDD and
							neoplasia.
						</p>
					...
					<Col md={5} className="d-flex flex-column">
						...
						<div className="mb-4">
							...
							<p
								...
								style={{ fontFamily: "Caveat", fontSize: 25 }}
							>
								Figure 4: CT scan showing Disc Herniation
							</p>
						</div>
						<div className="mb-4">
							<img
				...
				<Row className="mb-3 pb-5 border-none">
					...
					<Col md={5} className="d-flex flex-column">
						<div className="mb-4">
							<iframe
								title="vimeo-player"
								src="https://player.vimeo.com/video/440726739"
								width="100%"
								height="350"
								frameborder="0"
								allowfullscreen
								title="Recovery Progression Following Disc Surgery"
							/>
						</div>
					</Col>
				</Row>
